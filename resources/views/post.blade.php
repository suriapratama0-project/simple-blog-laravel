    ...
    <!-- <article class="py-8">
        ...
        <div>
            ...
            <a class="hover:underline text-base text-gray-500"
                href="/categories/{{ $post->category->slug }}">{{ $post->category->category_names }}</a> |
        ...
        <div class="flex justify-between px-4 mx-auto max-w-screen-xl ">
            <article
                ...
                <header class="mb-4 lg:mb-6 not-format">
                    <a href="/posts" class="font-small text-blue-500 hover:underline my-2">
                        &laquo; Back to Posts
                    </a>
                    <address class="flex items-center mb-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                ...
                                <a class="hover:underline block my-2" href="/posts?category={{ $post->category->slug }}">
                                    <span
